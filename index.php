            <?php include 'header.php';?>
             ...
             <ul><h6>Termine im SEMESTER</h6> </ul>
              <table align="center" valign="middle" class="tg">
                  ...
                  <tr>
                    <td class="tg-28r4">Themenveröffentlichung und Freischaltung des Formulars</td>
                    <td class="tg-28r4">Freitag, 01.12.2017, 13.00 Uhr &gt;&gt; Formular zur Anmeldung (deaktiviert)</td>
                  </tr>
                  <tr>
                    <td class="tg-28r4">Bewerbungszeitraum</td>
                    <td class="tg-28r4">bis Mittwoch, 05.12.2017, 23.59 Uhr</td>
                  </tr>
                   <tr>
                    <td class="tg-28r4">Themenvergabe</td>
                    <td class="tg-28r4">Dienstag, 06.12.2017</td>
                  </tr>
                  <tr>
                    <td class="tg-28r4">Anmeldung im FlexNow</td>
