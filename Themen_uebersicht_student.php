...
<table class="tg" style="width: 100%;  margin: 1px;">   <!--Thema der Anmeldung mit sufklappbaren Unterthemen-->
    <th class="tg-py0s"> 
        <a  style="color: #ffffff; " data-toggle="collapse"  href="#id1" aria-expanded="true" aria-controls="id1">Projektseminar: Entwicklung von Webapplikationen</a>
        <button type="button" class="btn btn-secondary disabled btn-sm" style="float: right;" data-toggle="tooltip" title="Der Anmeldezeitraum ist leider abgelaufen">Anmeldung gesperrt</button>   <!--Button mit Tooltip-->
