<?php
	...
	if(isset($_SESSION["acp"]) && wert("benutzer WHERE id='".$_SESSION["acp"]."'", "gruppe") == 1){
		...
		$abfrage = mysql_query("SELECT * FROM benutzer_login ORDER BY timestamp desc LIMIT ".$seite.",".$proseite);
