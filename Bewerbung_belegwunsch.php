<?php include 'header.php';?>
    <h2 class="card-title">Bewerbung -> Belegwunsch-Verfahren</h2>   
                ...
                <div class="formbox">            
                        ...
                        <table>
                               ...
                               <tr>
                                  <td style="width: 30%;"><label style="padding-left: 5%; text-align:left" for="inputoPhase"><b>Belegwunsch 1:</b> </label></td>
                                   ...
                                   <td style="width: 30%;"><label style="padding-left: 5%; text-align:left" for="inputoPhase"><b>Belegwunsch 2:</b> </label></td>
                                    <td style="width: 50%; padding-right: 5%;"><select class="form-control" id="b1">
                                    <option></option>
                                    <option>Burger</option>
                                    <option>Pizza</option>
                               ...
                               <tr>
                                   <td style="width: 30%;"><label style="padding-left: 5%; text-align:left" for="inputoPhase"><b>Belegwunsch 3:</b> </label></td>
                                    <td style="width: 50%; padding-right: 5%;"><select class="form-control" id="b1">
                                    <option></option>
                                    <option>Burger</option>
                                    <option>Pizza</option>
