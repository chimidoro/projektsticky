...
<table align="center" valign="middle" class="tg" style="width:90%" >
    <tr>
        ...
        <th class="tg-py0s">Modul</th>
        <th class="tg-py0s">Titel</th>
        <th class="tg-py0s">Dozent</th>
        <th class="tg-py0s">Semester</th>
        <th class="tg-py0s">Funktionen</th>
    </tr>
    <tr>
        ...
        <td class="tg-28r4" style="text-align:center;"> <a href="/bearbeiten.php"><img id="bearbeiten" src="img/edit.png" alt="Bearbeiten"></a> 
            <a href="/bearbeiten.php"><img id="delete" src="img/delete.png" alt="Bearbeiten"></a>                          
        </td>
    </tr>  
    <tr>
...
<?php include 'navi_themen_uebersicht.php'; ?>
