                ...
                <div class="formbox">            
                        <form action="index.php" method="post">
                            ...
                            <table>
                             ...
                             <table>
                             <tr>
                                 <td><label for="Termine"><b>Bewerbungsfristen</b></label> </td>
                             ...
                             <table>
                             <tr>
                                 <td style="width: 17%;" ><label for="inputTitel"><b>Titel:</b></label>  </td> 
                                 <td><input type="text" class="form-control" id="inputTitel" placeholder="Titel"> </td> 
                             </tr>

                              <tr>
                                 <td><label for="Vorraussetzung" ><b>Zulassungsvorraussetzung:</b></label>  </td> 
                              ...
                              <tr>
                               ...
                               <tr>
                                   <td><label for="inputVerfahren"><b>Verfahren:</b> </label></td>
                               ...
                               <tr>
                                 ...
                                 <td><label for="inputBeschreibung"><b>Beschreibung:</b></label>  </td> 
